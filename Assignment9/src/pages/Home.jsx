  ...
  return (
    <>
      ...
      <Container maxWidth="lg" sx={{ px: 0 }}>
        {/* HERO: split card (image left, copy + search right) */}
        <Card
          variant="outlined"
          sx={{
            borderRadius: 3,
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <PrimaryButton
                onClick={() => navigate(isAuthed ? "/jobs" : "/login")}
       ...
       {/* FEATURES / VALUE props (outlined cards like Job items) */}
<Grid
  container
  spacing={3}
  sx={{
